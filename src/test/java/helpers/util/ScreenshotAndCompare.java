...
public class ScreenshotAndCompare {
	...
	public void sparkTakeScreenshotOnly(String name, WebAutomator automator, ExtentTest test) throws IOException {
		WebDriver driver = automator.getDriver();
		File dir = new File("./sparkreports/screenshots/");
		if (!dir.exists()) dir.mkdirs();

		Screenshot screenshot = new AShot().takeScreenshot(driver);
		File imgFile = new File(dir, name + ".png");
		ImageIO.write(screenshot.getImage(), "PNG", imgFile);

		// Agregar al reporte
		test.info("Captura: " + name,

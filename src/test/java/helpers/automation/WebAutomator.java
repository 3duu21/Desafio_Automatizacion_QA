...
import helpers.exceptions.NoValidBrowserException;
...
public class WebAutomator {
	...
	public WebAutomator(Browser browser,boolean isHeadless, boolean isIncognito, Duration max_wait) throws NoValidBrowserException {
		switch (browser) {
			case CHROME:
				WebDriverManager.chromedriver().setup(); // ✅ Descarga y configura automáticamente el chromedriver correcto
				...
				driver = new ChromeDriver(options); // ✅ Usa el driver con opciones configuradas
				break;
